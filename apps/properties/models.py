...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="India", blank_label="(select country)"
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Delhi")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="140"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="KB8 Avenue"
    )
